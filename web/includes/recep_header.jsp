...
<ul class="sf-menu" id="nav" style="text-align:left;">
	<li><a href="recep_homepage.jsp">Home</a></li>
        <li><a href="add_docs.jsp" title="Add Documents"><font style="font-size: 20px;">Add Documents</font></a>
            
        <li><a href="forward_docs.jsp" title="Forward Documents"><font style="font-size: 20px;">Forward Documents</font></a>
